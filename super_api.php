...
*/
ob_start();
$API_KEY = '442857605:AAFTodfL7xGq18R944Zbw9GYh59mYk9DmVs'; //add your bot token
$bot_ = "GManabot"; // add your bot username 
$sudo = 284458843; // add your id 
...
bot('sendMessage',[
    'chat_id'=>$chat_id,
    'text'=>"لطفا زبان خودتون رو انتخاب کنید
زبان های دیگر بزودی اضافه میشود", 
 ...
 'parse_mode'=>'html',
   'reply_markup'=>json_encode([
    ...
    ['text'=>"Add me to your Gp ♣️️", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
     ...
     [
     ['text'=>"support 💡", 'url'=>"t.me/saeid025"]
     ],
     [
...
if($data == 'persian'){
  	bot('editmessagetext',[
        'chat_id'=>$cllchatid,
	'message_id'=>$cllmsegid,
    'text'=>"زبان فارسی با موفقیت انتخاب شد
کاری که میخواهید انجام دهید را انتخاب کنید",
 'parse_mode'=>'html',
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
	   [
    ['text'=>"افزودن من به گروه ➕", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
    ],
     [
     ['text'=>"❔گروه پشتیبانی❓", 'url'=>"t.me/saeid025"]
     ],
     [
...
";
    ...
    bot('sendmessage', [
                'chat_id' => $chat_id,
                'text' =>"_گروه با موفقیت اضافه شد ✔
لطفا زبان خود را انتخاب کنید❗️_",
                'reply_to_message_id'=>$message->message_id,
         'parse_mode'=>'Markdown',
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
